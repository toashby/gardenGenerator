...
public class Simplex2D {
    ...
    //the bulk of this code comes from https://github.com/SRombauts but has been modified
    //to suit my needs. Credit to him for his working simplex noise implementation.
    ...
    // 2D simplex noise
    public double noise(double xin1, double yin1, int zoom) {
        double xin = xin1/zoom;
        double yin = yin1/zoom;
